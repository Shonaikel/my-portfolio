...
export default function ContactSection() {
    return (
      <section className="relative py-28 px-6 text-white overflow-hidden bg-[#17171a]">
  
        <h2 className="absolute inset-0 flex items-center justify-center text-[70px] md:text-[130px] font-extrabold 
                        leading-none text-center pointer-events-none select-none text-lime-900">
        ...
        <div className="relative max-w-4xl mx-auto flex justify-center">
          ...
          {/* Card */}
            <div className="w-full max-w-md bg-gray-900/60 backdrop-blur-lg border
                          border-white/5 rounded-2xl p-10 shadow-2xl text-center ">
  
            <h3 className="text-2xl font-semibold mb-6"> Contact Me </h3>
  
            {/* Email */}
            <a href="mailto:ljonaikel1@gmail.com?subject=Portfolio%20Inquiry%20-%20Let%E2%80%99s%20Work%20Together&body=Hello%20Luis,%0A
            %0AI%20visited%20your%20portfolio%20and%20I%E2%80%99m%20interested%20in%20working%20with%20you.%20I%20would%20love%20to%20
            discuss%20a%20potential%20project%20or%20collaboration.%0A%0APlease%20let%20me%20know%20your%20availability.%0A%0ABest%20regards,"
